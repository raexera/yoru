...
local user_profile_widget = {}
local create_profile_control_center = function()
...
local function create_profile_info_center()
	local profile_imagebox = wibox.widget({
		{
			id = "icon",
			image = beautiful.pfp,
...
user_profile_widget.control_center = create_profile_control_center()
user_profile_widget.info_center = create_profile_info_center()

return user_profile_widget
