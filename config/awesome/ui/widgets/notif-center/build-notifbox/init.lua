...
local widget_icon_dir = config_dir .. "ui/widgets/notif-center/icons/"

local empty_notifbox = require("ui.widgets.notif-center.build-notifbox.empty-notifbox")
local notifbox_scroller = require("ui.widgets.notif-center.build-notifbox.notifbox-scroller")
...
naughty.connect_signal(
	...
	function(n)
		...
		if not notif_icon then
			notif_icon = gears.color.recolor_image(beautiful.notification_icon, beautiful.accent)
		end
