...
local get_taglist = function(s)
    ...
    local ghost = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/taglist/ghost.png")
    local ghost_icon = gears.color.recolor_image(ghost, beautiful.ghost)

    local dot = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/taglist/dot.png")
    local dot_icon = gears.color.recolor_image(dot, beautiful.dots)

    local pacman = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/taglist/pacman.png")
