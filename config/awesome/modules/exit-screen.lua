...
local hibernate_command = function()
        awesome.emit_signal("module::exit_screen:hide")
        awful.spawn.with_shell("systemctl hibernate -i")
end
...
local hibernate = create_button(hibernate_text_icon, beautiful.color7, "Hibernate", hibernate_command)
